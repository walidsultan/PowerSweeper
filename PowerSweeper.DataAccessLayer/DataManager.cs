        ...
        private static IObjectServer Server
        {
            get
            {
                if (_Server == null)
                {
                    ...
                    _Server = Db4objects.Db4o.CS.Db4oClientServer.OpenServer(serverConfiguraiton, HttpContext.Current.Request.PhysicalApplicationPath + @"App_Data\PowerSweeper.db4o", 0);
                }
                return _Server;
            }
        }
